...
The first line of code makes "census_pop_est_2018" represent the data set when you use it later in other lines. The second line of code makes
...
```{r}
pal_problem <- colorFactor("viridus",
